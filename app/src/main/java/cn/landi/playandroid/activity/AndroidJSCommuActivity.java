 ...
 * @edit TODO
 */
@Route(path = RouteUrl.JS_ACTIVITY)
public class AndroidJSCommuActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_android_js_commu);
        initView();
        initWebView();
    }
    ...
    private void initWebView() {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                Log.d("chenhui", "shouldOverrideUrlLoading...url=" + url);
                //自己处理新的url
                webView.loadUrl(url);
                //true就是自己处理
                return true;
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                Log.d("chenhui", "onPageStarted...url=" + url);
                if (progressDialog != null && progressDialog.isShowing()) {
                    progressDialog.dismiss();
                }
                //弹出菊花
                progressDialog = new ProgressDialog(AndroidJSCommuActivity.this);
            ...
            public void onPageFinished(WebView view, String url) {
                Log.d("chenhui", "onPageFinished...url=" + url);
                //隐藏菊花:不为空，正在显示。才隐藏
                if (progressDialog != null && progressDialog.isShowing()) {
                    progressDialog.dismiss();
                }
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public void onProgressChanged(WebView view, int newProgress) {
                Log.d("chenhui", "onProgressChanged...newProgress=" + newProgress);
                if (progressDialog != null && progressDialog.isShowing())
            ...
            public boolean onJsAlert(WebView view, String url, String message, final JsResult result) {
                Log.d("chenhui", "onJsAlert...url=" + url + ",message" + message);
                AlertDialog.Builder builder = new AlertDialog.Builder(AndroidJSCommuActivity.this);
            ...
            public boolean onJsConfirm(WebView view, String url, String message, final JsResult result) {
                Log.d("chenhui", "onJsConfirm...url=" + url + ",message" + message);
                AlertDialog.Builder builder = new AlertDialog.Builder(AndroidJSCommuActivity.this);
                builder.setTitle("提示:" +
            ...
            public boolean onJsPrompt(WebView view, String url, String message, String defaultValue,
                ...
                builder.setMessage(message);//这个message就是alert传递过来的值
                //添加一个EditText
                final EditText editText = new EditText(AndroidJSCommuActivity.this);
        ...
        webView.addJavascriptInterface(new Object() {
            ...
            public void showToast(String msg) {
                Log.d("chenhui", "showToast msg:" + msg);
